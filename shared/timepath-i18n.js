...
(function () {
    ...
    var DICT = {
        ...
        "auth.mobile_tab_signed_out": { zh: "登录", en: "Sign in" },
        "auth.mobile_tab_signed_in": { zh: "我的", en: "Account" },
        "auth.mobile_tab_local_only": { zh: "本地", en: "Local" },
        "auth.confirm_sign_out": { zh: "确定要退出登录吗？", en: "Sign out of your account?" },
